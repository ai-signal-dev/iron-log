...
const translations = {
  en: {
    ...
    todaysDashboard: "Today's Workout",
    noExercisesYet: 'No exercises added yet',
    voiceHint: 'Say: "Bench Press 80kg 10 reps"',
    frequentlyUsed: 'Frequently Used',
    quickWeight: 'Quick Select',
    listening: 'Listening...',
    // Timer
    start: 'Start',
    pause: 'Pause',
  ...
  ja: {
    ...
    todaysDashboard: '今日のワークアウト',
    noExercisesYet: 'まだ種目が追加されていません',
    voiceHint: '例: 「ベンチプレス 80キロ 10回」',
    frequentlyUsed: 'よく使う種目',
    quickWeight: 'クイック選択',
    listening: '音声認識中...',
    // Timer
    start: 'スタート',
